...
class Client():
    ...
    def get(self, endpoint, params=None, json=None, data=None):
        return self.session.get(self.URL + endpoint, params=params, json=json, data=data)
    ...
    def put(self, endpoint, params=None, json=None, data=None):
        return self.session.put(self.URL + endpoint, params=params, json=json, data=data)
