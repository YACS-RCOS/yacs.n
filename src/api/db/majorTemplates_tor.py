...
class MajorTemplates(Model):
    ...
    '''
    async def find_major_template(self, major, year, semester):
        sql =   """
                SELECT * 
        ...
        courses, error = await self.db.execute(sql, args, True)
    ...
    '''
    async def find_courses(self, major, year, semester):
        sql =   """
    ...
    '''
    async def find_courses_already_taken(self, major, year, semester):
