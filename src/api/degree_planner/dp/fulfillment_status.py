...
class Fulfillment_Status():
    ...
    def __init__(self, template, fulfillment_set:set=None):
    ...
    def get_required_count(self) -> int:
        return self.template.courses_required
    ...
    def __repr__(self) -> str:
        return f"template {self.template.name} specifications: {self.template.specifications}  required count: {self.get_required_count()}  fulfillment set: {[str(e) for e in self.fulfillment_set]}"
