...
# login
browser.get('http://catalog.rpi.edu/preview_program.php?catoid=24&poid=6473&returnto=604')
time.sleep(1)
f = open('jsons/mechengcu.json', 'w', encoding='utf-8')

result = {
    "Major": "Mechanical Engineering Curriculum",
    "Y1": "First Year",
    "Y1S1": ["Fall"],
    "Y1S2": ["Spring"],
    "Y2": "Second Year",
