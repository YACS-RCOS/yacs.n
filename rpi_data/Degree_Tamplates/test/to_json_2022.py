f = open("temp/majorData.txt", "r", encoding='UTF-8')
fout = open("jsons/majorDataTemp.json", "w", encoding='UTF-8')
lines = f.readlines()
...
for line in lines:
    ...
    line = line.strip()
    if line == 'or Free Elective Credit Hours: 4 (if Statistics Option did count toward the Science Core)':
        i=3
    if line == 'Restricted Elective Credit Hours: 3-4':
        i=3
    if line != "":
        if line == 'End':
            fout.write(']\n  }\n]\n')
